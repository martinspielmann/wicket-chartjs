...
/**
 * The Class ScatterChartData provides chart data used by scatter charts.
 * 
 * @param <T> the generic type of it's dataset
 * 
 * @author Martin Spielmann
 */
public class ScatterChartData<T extends AbstractDataset> extends AbstractChartData<T> {
