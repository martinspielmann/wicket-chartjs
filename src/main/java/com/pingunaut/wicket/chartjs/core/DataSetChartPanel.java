 ...
 */
public abstract class DataSetChartPanel<C extends IDataSetChart<D, O, S>, D extends AbstractChartData<S>, O extends AbstractChartOptions, S extends AbstractBaseDataSet>
      extends AbstractChartPanel<C, O> {
    ...
    */
   public DataSetChartPanel(final String id, final IModel<? extends C> c) {
      super(id, c);
   }
    ...
    *           the height
    */
   public DataSetChartPanel(final String id, final IModel<? extends C> c, final int width, final int height) {
