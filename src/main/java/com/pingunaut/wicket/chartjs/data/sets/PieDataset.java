...
/**
 * The Class PieDataset provides all information needed for {@link BarData} .
 * 
...
public class PieDataset extends Dataset {
	...
	// The properties below allow an array to be specified to change the value
	// of the item at the given index

	// String or array - Line color
	private String borderColor = "rgba(220,220,220,1)";

	// String - cap style of the line. See
	// https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineCap
	private String borderCapStyle = "butt";

	// Array - Length and spacing of dashes. See
	// https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/setLineDash
	// borderDash: [],

	// Number - Offset for line dashes. See
	// https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineDashOffset
	private Double borderDashOffset = 0.0;

	// String - line join style. See
	...
	// Wlines connecting points
	private Double tension = 0.1;

	// The actual data
	private final List<Number> data = new ArrayList<>();

	// String - If specified, binds the dataset to a certain y-axis. If not
	// specified, the first y-axis is used.
